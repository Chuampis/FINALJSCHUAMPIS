...
function mostrarElProducto(card) {
    ...
    <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div id=stock${elementoDelArray.id} class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Sale</div>
                        <div class="d-flex">
    ...
    `
    container.appendChild(verProducto)
}
